...
export declare const TONE: readonly ["neutral", "primary", "success", "warning", "danger", "info", "added", "deleted"];
/** `CalloutTone` — `Callout` and `Banner`. core-primitives.d.ts:19. */
export declare const CALLOUT_TONE: readonly ["info", "warning", "danger", "success", "neutral", "positive", "caution", "critical"];
/** `TableRowTone` — `rowTone` on either `Table` shape. core-primitives.d.ts:14. */
export declare const TABLE_ROW_TONE: readonly ["default", "muted", "accent", "neutral", "success", "warning", "danger", "info", "positive", "caution", "critical"];
/** `TextProps['tone']` — core-primitives.d.ts:69. */
export declare const TEXT_TONE: readonly ["primary", "secondary", "tertiary", "quaternary"];
/**
 ...
 */
export declare const UNPAINTED: Readonly<Record<string, readonly string[]>>;
