 ...
 */
export type CanvasProp = string | number | boolean | null | CanvasProp[] | {
...
export type ExtractResult = {
    ...
    readonly ok: false;
    readonly error: ExtractError;
};
/** Build a `text` node. */
export declare function text(value: string): CanvasNode;
/** Build an `element` node. */
export declare function element(tag: string, props: Record<string, CanvasProp>, children: CanvasNode[]): CanvasNode;
/** Build an `unsupported` node. */
export declare function unsupported(reason: string, snippet?: string): CanvasNode;
...
export declare function countNodes(node: CanvasNode): NodeCounts;
/** Depth-first walk in document order. */
export declare function walk(node: CanvasNode, visit: (node: CanvasNode) => void): void;
